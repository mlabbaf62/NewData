<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateAccount2.aspx.cs" Inherits="LoginProject.CreateAccount2" EnableViewState="true" ViewStateEncryptionMode="Always" %>
...
<body class="" dir="rtl" ng-app="myApp" ng-controller="myCtrl" id="myCtrlID">
    <div class="container">
                            ...
                            <div id="legalTab" class="tab-pane fade">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12     GamBoxFrame">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" tabindex="14" style="text-align:left;direction:ltr" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" maxlength="11" id="txt_RequestNationalCode" value="" ng-model="Account_Info.RequestNationalCode" />
                                    </div>
                                    <div class="col-md-4">
                                        <span class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                            نام شرکت:
        ...
        <script src="js/CAccount.js"></script>
    </div>
