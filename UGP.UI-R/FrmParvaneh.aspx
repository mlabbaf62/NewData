<%@ Page Title="ثبت درخواست پروانه" EnableEventValidation="false" Language="C#" MasterPageFile="~/UGPMaster.Master" AutoEventWireup="true" CodeBehind="FrmParvaneh.aspx.cs" Inherits="UGP.UI.FrmParvaneh" %>


<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <script type="text/javascript" src="parvaneh/parvanehGam.min.js?v=23"></script>
    <script type="text/javascript" src="Config/Parvaneh/GamState.js?v=23"></script>
    <script type="text/javascript" src="TransferGam/Bazdid.min.js?v=23"></script>
            ...
            <div id='divStep'>
                <div class="col-md-12 col-sm-12 col-xs-12 hidden-sm hidden-xs" style="padding: 0px; padding-right: 15px; float: right;">
                    ...
                    <div ng-init="StyleFunc.Load()" id="step-div{{$index}}" ng-style="StyleFunc.GetWidth($index)" style="direction: rtl; float: right" class="step-div form-inline" ng-repeat="A in GamsArray">
                        ...
                        <span class="col-md-12 col-lg-12 divDeskShap-span" ng-style="StyleFunc.Getalign($index)" style="color: black;" title="{{A.Title}}" ng-bind="A.PageTitle"></span>
                ...
                <div style="padding: 0 35px  0 35px">
                    <div class="GamBoxFrame2 col-md-12" ng-show="GamInputData.CurrentNosaziCode!=''" style="color: black; font-weight: bold; float: right;">
                        ...
                        <div ng-show="GamInputData.HideCurrentNosaziCode !=true">
