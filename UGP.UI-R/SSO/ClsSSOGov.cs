...
namespace UGP.UI.SSO
{
    ...
    public partial class ClsSSOGov
    {
        ...
        public void GotoLoginPage()
        {
            ...
            //string url = string.Format(@"https://sso.my.gov.ir/oauth2/authorize?response_type=code&scope=openidprofile&client_id={0}&state=SSOGov&redirect_uri={1}&nonce=nonce",
        ...
        public void GetAccessToken()
        {
            try
            {
                ...
                HttpWebRequest request = (HttpWebRequest)WebRequest.Create("https://sso.my.gov.ir/oauth2/token");
        ...
        public void ValidateToken()
        {
            ...
            {
                ClsLog.AddLog("ValidateToken ex : " + (ex.Message));
            }
            // GetRefreshToken();
        }
        ...
        public void GetUserInfo()
        {
            ...
            var tmpUserResponse = GetWebRequest("https://sso.my.gov.ir/api/v1/user/userinfo", "", tmpHeader);
        ...
        public void Logout()
        {
            string Url = "https://sso.my.gov.ir/logout";
