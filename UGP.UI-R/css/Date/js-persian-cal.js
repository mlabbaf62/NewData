...
AMIB.persianCalendar = function (b, a) {
    ...
    this.GenrateCal = function (f, g, A, B, dday) {
        ...
        if (this.EnableDays != undefined && this.EnableDays.indexOf(currentDate) == -1) {
        ...
        if (this.DisableDays != undefined && this.DisableDays.indexOf(currentDate) == -1 && f.className.indexOf('friday') == -1) {
            //f.className += ' ActiveDay '; //f.className += " DeActiveDay";//f.classList.add();
        } else {
...
AMIB.persianCalendar.prototype.SetDisableDate = function (pdates, pRevisitDate) {
...
AMIB.persianCalendar.prototype.fillDateField = function (b) {
    ...
    try {
        ...
        DateBazdidPlugin.DateClickEvent(a.value);
    }
    catch(ex){}
