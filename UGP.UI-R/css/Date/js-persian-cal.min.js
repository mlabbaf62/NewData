/*
 ...
 @author Amir Masoud Irani( AMIBOld )
 amibct@gmail.com
 http://amib.ir/weblog
*/
if("undefined"===typeof AMIBOld)var AMIBOld={};
...
AMIBOld.persianCalendar=function(b,a){var c={inputID:"",extraInputID:"",extraInputFormat:"JD",initialDate:"",defaultDate:"",autoCreateButton:!0,divPickerClassName:"pickerOld",btnClassName:"pcalBtnOld",onchange:!1},d;this.getOption=function(a){return c[a]};this.oldDocumentOnClick=!1;this.enabled=!0;this.inputID=b;this.input=A$(b);for(d in a)d in c?c[d]=a[d]:alert(d.toString()+" option is not supported");c.defaultDate instanceof Array||(c.defaultDate=isPersianDate(c.defaultDate));d=this.input;if(c.autoCreateButton){var e=
...
AMIBOld.persianCalendar.prototype.createDateTable=function(b,a,c){var d=cE("table"),e,g,f,h,k,j;g=this.getOption("defaultDate");j=new Date;f=gregorian_to_jd(j.getFullYear(),j.getMonth()+1,j.getDate());j=jd_to_persian(f);(a=isPersianDate(a))?a=persian_to_jd(a[0],a[1],a[2]):g?(a=persian_to_jd(g[0],g[1],g[2]),c=g.join("/")):a=f;c=isPersianDate(c);a=jd_to_persian(a);var l=Math.floor(persian_to_jd(a[0],a[1],1)+3)%7;e=d.insertRow(-1);g=e.insertCell(-1);g.className="pickerHead";g.colSpan=7;e=cE("div");e.className=
